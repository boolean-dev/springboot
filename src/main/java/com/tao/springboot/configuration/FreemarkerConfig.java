...
import com.tao.springboot.shiro.HasPermissionTag;
...
public class FreemarkerConfig {
	...
	public FreeMarkerConfigurer freeMarkerConfigurer() throws IOException, TemplateException {
		...
		configuration.setSharedVariable("shiro", new HasPermissionTag());
	...
	/*protected static class FreeMarkerConfiguration {
		...
		protected void applyProperties(FreeMarkerConfigurationFactory factory) {
			...
			variables.put("hasPermission", new HasPermissionTag());
