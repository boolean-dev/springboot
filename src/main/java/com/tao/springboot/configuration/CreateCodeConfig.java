...
public class CreateCodeConfig {
    ...
    private static final String BASE_PACKAGE = "com.tao.springboot";
    ...
    public static final String DAO_IMPL_PACKAGE = BASE_PACKAGE + ".impl";//生成的Controller所在包
