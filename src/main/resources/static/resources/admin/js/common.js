		...
		browser: function(options) {
			...
			return this.each(function() {
				...
				$browserButton.click(function() {
					...
					$browserOrderType = $('<select name="orderType" class="browserOrderType"><option value="name">' + message("admin.browser.name") + '<\/option><option value="size">' + message("admin.browser.size") + '<\/option><option value="type">' + message("admin.browser.type") + '<\/option><option value="time">'+message("admin.browser.time")+'<\/option><\/select>').appendTo($browserBar);
