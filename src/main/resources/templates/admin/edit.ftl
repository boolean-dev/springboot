	...
	<div class="wrapper wrapper-content animated fadeInRight">	
		<div class="ibox">
			...
			<div class="ibox-content">
				<form id="inputForm" action="${base}/admin/update" method="post" class="form-horizontal">
					<input type="hidden" name="id" value="${admin.id}" />
					<input type="hidden" name="isLocked" value="[#if admin.isLocked == true]true[#else]false[/#if]" />
					<input type="hidden" name="loginFailureCount" value="${admin.loginFailureCount}" />
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" name="name" class="text" maxlength="20" value="${admin.name}" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2 text-right">新密码: </div>
						<div class="col-sm-4">
						...
						<div class="col-sm-2 text-right" >确认新密码: </div>
						<div class="col-sm-4">
					...
					<div class="col-sm-2 text-right">部门:</div>
						<div class="col-sm-4">
							<input type="text" name="department" class="text" maxlength="20" value="${admin.department}" />
						</div>
						
						<div class="col-sm-2 text-right">E-mail: </div>
						<div class="col-sm-4">
							<input type="text" name="email" class="text" maxlength="20"  value="${admin.email}"/>
						</div>
					</div>
					<div class="hr-line-dashed"></div>
					...
					<div class="form-group">
						...
						<div class="i-checks">
							...
							[#list roles as role]
								<label>
									<input type="checkbox" name="ids" value="${role.id}"[#if admin.id=1] disabled="disabled"[/#if][#if ids?seq_contains(role.id)] checked="checked"[/#if] />${role.name}
								</label>
							[/#list]
							</span>
							</div>
