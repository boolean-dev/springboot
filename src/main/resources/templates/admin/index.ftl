                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="loading">
                        ...
                        <ul class="nav nav-second-level">
                        		<li><a class="J_menuItem" href="${base}/admin/order/list">订单管理</a></li>
                            <li><a class="J_menuItem" href="${base}/admin/orderDetail/list">订单详情管理</a></li>
                        </ul>
                    ...
                    <li class="loading">
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="${base}/admin/product/list">商品管理</a></li>
                            <li><a class="J_menuItem" href="${base}/admin/productCategory/list">商品分类管理</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="loading">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a class="J_menuItem" href="${base}/admin/role/list">角色管理</a></li>
                            <li><a class="J_menuItem" href="${base}/create">基础代码生成</a></li>

                            <li><a class="J_menuItem" href="${base}/admin/order/list">生成测试</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
